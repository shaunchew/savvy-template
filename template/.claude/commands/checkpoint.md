---
description: Tag a mid-session checkpoint — snapshot HANDOVER, prompt for /lesson, and append a commit marker.
---
...
1. Run `/handover` to regenerate `HANDOVER.md` from current state.
...
5. Commit with `git commit --author="Shaun <scwj1210@gmail.com>" -m "checkpoint: <one-line summary>"`.
